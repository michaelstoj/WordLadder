 ...
 *
 * @author Matthew Fallon, Reece Hooker
...
public class WordLadder {
     ...
     * and the neighbors of each word as an an adjacency list.
     * <p>
     * Will start with an empty adjacency list and will be built as needed.
     */
    public static HashMap<String, LinkedList<String>> words = new HashMap<>();
    ...
    public static void readFile(String fileName, HashMap<String, LinkedList<String>> words) {
        try {
            Scanner tFile = new Scanner(new File(fileName));
            while (tFile.hasNext()) {
                // add words to the hashset
                words.put(tFile.next().trim(), new LinkedList<>());
            }
            tFile.close();
